...
l1_data_size=(32kB 128kB 64kB) # l1_data_size + l_instraction_size < 256kB
l1_instraction_size=(64kB 128kB)
l2_size=(512kB 1MB 2MB 4MB) # less than 4MB
